      ...
      <div className="landing-container">
        ...
        <div className="title-container">
          ...
          <div className="sign-up-container">
            ...
            <div className="sign-up-box">
              ...
              <div className="text-center sign-up-button">
                <button className="button1" type="button" >Crear Cuenta Estudiantil</button> 
              </div>
            </div>
            ...
            <div className="sign-up-box">
              ...
              <div className="text-center sign-up-button">
                <button className="button1"  type="button" >Crear Cuenta Profesor</button> 
              </div>
            </div>

            {/* ADMINISTRADOR */}
            <div className="sign-up-box">
              <h1 className="text-center">Gestiona todos tus usuarios y materias</h1><br/>
                <div>
                <ul className="text-list">
                  <li>Gestiona los permisos de profesores y estudiantes</li> <br/>
                  <li>Gestiona todas tus materias</li> <br/>
                </ul> 
              </div>
              <div className="text-center sign-up-button">
                <button className="button1" type="button" >Crear Cuenta Administrador</button> 
              </div>
            </div>
          ...
          <div className="login-container text-center flex-vertical text-white">
            ...
            <button className="button3" type="button" >Iniciar sesion</button>
          </div>
